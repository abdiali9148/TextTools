# CS 1440 Project 2: Text Tools - Troubleshooting
...
*   Enter the `src/` directory of your Project 2 project and run this command to mark the file `tt.py` as executable:
...
```
bash: /c/Users/user/Desktop/cs1440-falor-erik-proj2/src/tt.py: /usr/bin/env: bad interpreter: No such file or directory
```
